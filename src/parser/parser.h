...
public:
    ...
    void parseStatementListPrime(std::vector<std::unique_ptr<Statement>>& statements);
    ...
    void parseFunctionStatementListPrime(std::vector<std::unique_ptr<Statement>>& statements);
    ...
    std::unique_ptr<Expression> parseExpressionSuffix(const std::string& identifier);
    
    std::vector<std::pair<std::unique_ptr<Type>, std::string>> parseParameterList();
    void parseParameterListPrime(std::vector<std::pair<std::unique_ptr<Type>, std::string>>& params);
