...
struct LinalgToLoops 
  : public PassWrapper<LinalgToLoops, OperationPass<ModuleOp>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(LinalgToLoops)
  ...
  llvm::StringRef getArgument() const override {
    return "lower-to-affine";
  }

  llvm::StringRef getDescription() const override {
    return "Lower Linalg dialect to affine";
  }
};
...
std::unique_ptr<mlir::Pass> createLowerToLoopsPass() {
  return std::make_unique<LinalgToLoops>();
}
